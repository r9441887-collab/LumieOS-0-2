...
pub unsafe fn set_alloc(alloc_cb: Option<super::diskio::AllocFn>, free_cb: Option<super::diskio::FreeFn>) -> i32 {
...
pub unsafe fn set_drive(read_cb: Option<super::diskio::FatReadFn>, write_cb: Option<super::diskio::FatWriteFn>) -> i32 {
    let drv = &mut *NTFS_DRIVER.as_mut_ptr();
    drv.disk_io.read_cb = read_cb;
    drv.disk_io.write_cb = write_cb;
    0
}
